...
router.get('/:username/games', getUserGamesByUsername);
router.get('/:username/friends', getUserFriendsByUsername);
router.get('/:username/info', getUserInfoByUsername);
router.get('/:username/invitations', getUserInvitationsByUsername);
